...
public:
	...
	bool TryJoinSession(int& SessionID, const std::string& SessionName, const bool& UsePassword, const std::string& Password);

public:
	bool InsertNewAccount(const std::string& UserName, const std::string& ID, const std::string& Password);
	bool InsertNewSession(int& SessionID, const std::string& SessionName, const int& MaxPlayer, const bool& bUsePassword, const std::string& Password);
